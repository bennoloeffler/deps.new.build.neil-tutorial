...
* [`src/cljs/bel/e05/`](src/cljs/bel/e05/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/bel/e05/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `e05` project root directory
...
The `debug?` variable in [`config.cljs`](src/bel/e05/config.cljs) defaults to `true` in
...
```clj
(ns bel.e05.example
  (:require [bel.e05.config :as config])
