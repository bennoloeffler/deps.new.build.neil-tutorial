...
* [`src/e05lein/`](src/e05lein/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/e05lein/core.cljs): contains the SPA entry point, `init`
* [`test/e05lein/`](test/e05lein/): test files (ClojureScript,
...
(headless test environment)
    * For Chromium, set the `CHROME_BIN` environment variable in your shell to the command that
    launches Chromium. For example, in Ubuntu, add the following line to your `.bashrc`:
       ...
       ```
5. Clone this repo and open a terminal in the `e05lein` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/e05lein/config.cljs) defaults to `true` in
...
```clj
(ns e05lein.example
  (:require [e05lein.config :as config])
